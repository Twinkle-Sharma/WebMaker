...
<body class="p-[10px]">
  <h1 class="text-[30px] font-[700]">Welcome to WebMaker</h1>
</body>
</html>
    `
  );
  ...
  return (
    <>
      ...
      <div className="container">
        <h3 className='text-[30px] font-[700]'>Create Amazing websites with <span className='bg-gradient-to-br from-violet-400  to-blue-600 bg-clip-text text-transparent'>WebMaker</span></h3>
        <p className='mt-2 text-[16px] text-[#b3b3b3]'>Describe your idea and ai will code for you.</p>

        <div className="inputBox">
          <textarea onChange={(e) => { setPrompt(e.target.value) }} value={prompt} placeholder='describe your website in detail.' className='resize-none'></textarea>
          {
            prompt !== "" ?
              <>
                <i onClick={getResponse} className='sendIcon text-[20px] w-[30px] h-[30px] flex items-center justify-center bg-[#2563eb] rounded-[50%] transition-all duration-300 hover:opacity-[.8]'><IoMdSend /></i>
              </> : ""
          }
        </div>
            ...
            </> : <>
              {
                loading ?
                  <div className='w-full h-full flex items-center justify-center flex-col'>
                    ...
                    <h3 className='text-[23px] mt-4 font-semibold'><span className='bg-gradient-to-br from-violet-400  to-blue-600 bg-clip-text text-transparent'>Generating</span> your website...</h3>
                  </div> :
                  <>
